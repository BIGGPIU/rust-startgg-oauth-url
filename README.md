...
Inspired (and basically translated) from [0xABADBABE-ops github repo "start.gg-oauth-full"](https://github.com/0xABADBABE-ops/startgg-oauth2-full?tab=readme-ov-file)
go star it! 
